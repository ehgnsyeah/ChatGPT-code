...
# - 술래에 A* 기반 장애물 회피 길찾기 보조 알고리즘 추가
# =========================================================
...
def get_chaser_pathfinding_action(chaser_pos, runner_pos):
    ...
    1. 도망자까지 직선 경로가 열려 있으면 바로 향한다.
    2. 벽/상자가 막고 있으면 A*로 우회 경로를 찾는다.
    3. A* 경로의 다음 waypoint 방향으로 이동한다.
    """
...
def print_menu():
    ...
    print("path on/off         : 술래 A* 길찾기 켜기/끄기")
    print("pathrate 숫자       : 술래 길찾기 사용 비율 설정. 예: pathrate 0.9")
    print("pathgrid 숫자       : 술래 길찾기 격자 크기 설정. 예: pathgrid 25")
    ...
    print(f"술래 A* 길찾기: {'ON' if CHASER_PATHFINDING_ENABLED else 'OFF'}")
    print(f"술래 길찾기 사용 비율: {CHASER_PATHFINDING_RATE:.2f}")
    print(f"술래 길찾기 격자: {PATH_GRID_SIZE}")

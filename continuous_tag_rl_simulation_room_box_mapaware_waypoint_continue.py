...
DOOR_WAYPOINT_OFFSET = 25.0
DOOR_WAYPOINT_REACH_RADIUS = 20.0
...
def get_chaser_fast_greedy_action(chaser_pos, runner_pos):
    ...
    waypoint = get_chaser_room_waypoint(chaser_pos, runner_pos)
...
def load_learning_data(chaser_ai, runner_ai):
    ...
    global CHASER_DOOR_WAYPOINT_ENABLED, DOOR_WAYPOINT_OFFSET
    rebuild_room_walls()
    reset_box_position()
